...
(16,'Cable: Enter in Cable Catalog','Cable types go into the Cable Catalog',2),
...
(206,'Wafer','',2),
(208,'Kit','Assembly of multiple parts',2),
(209,'Hardware','Non-specific hardware components',2),
(210,'Serial Device Server','Ethernet to RS232/RS485/...',2),
(211,'Beam Stop','Any device intended to stop a beam',2),
(212,'Controller - Feedback','Any type of feedback controller',2),
(213,'Network Switch','',2),
(214,'Gauge/Sensor - Capacitive','',2),
(215,'Movable Crate/Pallet','A special type of location intended to be moved around by changing it\'s parent',1),
(216,'Bulk','Used to track large quantities as one entity',2),
(217,'Septum','',2),
(218,'Casters/Wheels','',2),
(219,'HPMU Controls','',2),
(220,'Test Fixture','',2),
(221,'Rack Mount Kit','Any bracket or chassis for mounting items in a rack',2),
(222,'Table Assembly','Top assembly of tables; e.g. Front End table assemblies',2),
(223,'Adaptor Card','',2),
(224,'Magnet Module Assembly','Top level magnet module assemblies',2),
(225,'Placeholder','Placeholder for TBD items',2),
(226,'Daughter Card','',2),
(227,'Guillotine','',2),
(228,'Radiation Monitor','',2),
(229,'Beam Position Monitor','',2),
(230,'Support Table','',2),
(231,'Jack','Any type of jack',2),
(233,'Mounting Plate','',2),
(234,'Bulk','Used to track large quantities as one entity',7);
